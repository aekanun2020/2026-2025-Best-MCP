...
# Supported MCP protocol versions (we echo the client's requested version if
# supported, otherwise default to the latest we know).
...
app = FastAPI(
    ...
    description="Model Context Protocol server for MySQL with Streamable HTTP transport",
    version="1.0.0",
    lifespan=lifespan
)
        ...
        if method == "initialize":
            ...
            return {
                ...
                "result": {
                    ...
                    "serverInfo": {
                        "name": "mysql-streamable-http-server",
                        "version": "1.0.0"
                    }
                }
            }
            ...
            tools = [
                {
                    ...
                    "description": """Get complete database context including schema, relationships, and MySQL syntax guide.
...
• MySQL syntax guide (LIMIT, NOW, etc.)
...
No parameters required.""",
                ...
                },
                {
                    ...
                    "description": "Execute a MySQL query on the database. Use get_database_context first to understand the schema and syntax.",
                    "inputSchema": {
                        "type": "object",
                        "properties": {
                            "query": {"type": "string", "description": "MySQL query to execute"}
                        },
                        "required": ["query"]
                    }
                },
            ...
            elif uri and uri.startswith("mysql://schema/"):
                table_name = uri.replace("mysql://schema/", "")
