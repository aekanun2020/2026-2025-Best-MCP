#!/usr/bin/env python3
"""
Test script for Streamable HTTP MCP Server (MySQL) using the official MCP SDK client
"""
import asyncio
import json
import logging
...
class TestMCPClient:
    """Test client for MCP Streamable HTTP server"""
    ...
    async def test_execute_query(self):
        ...
        logger.info(f"Query result: {json.dumps(result.content, indent=2, default=str)}")
    ...
    async def test_preview_table(self):
        ...
        resources = await self.session.read_resource("mysql://tables")
        ...
        if tables:
            ...
            logger.info(f"Preview result: {json.dumps(result.content, indent=2, default=str)}")
    ...
    async def test_database_info(self):
        ...
        logger.info(f"Database info: {json.dumps(result.content, indent=2, default=str)}")
