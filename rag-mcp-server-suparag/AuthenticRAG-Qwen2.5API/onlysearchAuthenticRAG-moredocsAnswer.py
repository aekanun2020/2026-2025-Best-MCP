...
def main():
    ...
    questions = questions = [
   'หน่วยงานราชการแห่งหนึ่งต้องการจัดซื้อวัสดุสำนักงานมูลค่า 300,000 บาท โดยได้แบ่งการจัดซื้อออกเป็น 2 ครั้ง ครั้งละ 150,000 บาท เพื่อให้สามารถใช้วิธีเฉพาะเจาะจงได้ การกระทำดังกล่าวถูกต้องหรือไม่?',
   'คณะกรรมการตรวจรับพัสดุของหน่วยงานแห่งหนึ่งมีจำนวน 5 คน ในการประชุมครั้งหนึ่งมีกรรมการมาประชุม 3 คน โดยประธานกรรมการมาประชุมด้วย ผลการลงมติมีกรรมการ 2 คนเห็นชอบ และ 1 คนไม่เห็นชอบ การประชุมและมติดังกล่าวสมบูรณ์หรือไม่?',
   'หน่วยงานราชการต้องการจัดซื้อครุภัณฑ์คอมพิวเตอร์มูลค่า 3,000,000 บาท โดยมีรายละเอียดคุณลักษณะเฉพาะที่ไม่ซับซ้อนและเป็นสินค้าที่มีอยู่ในระบบ e-catalog หน่วยงานต้องใช้วิธีการจัดซื้อแบบใด และหากใช้วิธีตลาดอิเล็กทรอนิกส์จะต้องดำเนินการในลักษณะใด?',
   'นาย ก. เป็นกรรมการพิจารณาผลการประกวดราคาอิเล็กทรอนิกส์ในโครงการจัดซื้อครุภัณฑ์ของหน่วยงาน หลังจากคณะกรรมการพิจารณาผลเสร็จสิ้นแล้ว หัวหน้าหน่วยงานต้องการแต่งตั้ง นาย ก. เป็นกรรมการตรวจรับพัสดุในโครงการเดียวกันนี้ด้วย เนื่องจาก นาย ก. มีความเชี่ยวชาญ การแต่งตั้งดังกล่าวสามารถทำได้หรือไม่?',
   'บริษัท ABC จำกัด และบริษัท XYZ จำกัด ต่างก็เข้ายื่นข้อเสนอในการประกวดราคาจัดซื้อครุภัณฑ์ของหน่วยงานราชการในคราวเดียวกัน โดยนาย สมชาย ซึ่งเป็นกรรมการผู้จัดการของบริษัท ABC จำกัด มีภรรยาชื่อ นางสมหญิง ถือหุ้นอยู่ในบริษัท XYZ จำกัด จำนวน 30% ของหุ้นทั้งหมด และบุตรชายที่ยังไม่บรรลุนิติภาวะถือหุ้นอีก 5% ในบริษัท XYZ จำกัด การยื่นข้อเสนอของทั้งสองบริษัทถือว่าเป็นผู้มีผลประโยชน์ร่วมกันหรือไม่?'
]
