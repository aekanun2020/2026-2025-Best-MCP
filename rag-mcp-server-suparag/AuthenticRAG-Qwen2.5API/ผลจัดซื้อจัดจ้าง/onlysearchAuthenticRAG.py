...
def main():
    ...
    questions = [
   'หัวหน้าหน่วยงานของรัฐ" ในราชการส่วนภูมิภาค หมายถึงตำแหน่งใด?',
   'การซื้อหรือจ้างตามระเบียบนี้ สามารถดำเนินการได้กี่วิธี และมีอะไรบ้าง?',
   'วิธีตลาดอิเล็กทรอนิกส์ (e-market) มีวงเงินในการซื้อหรือจ้างเท่าไร และมีกี่ลักษณะ?',
   'คณะกรรมการซื้อหรือจ้างแต่ละคณะต้องประกอบด้วยบุคคลอย่างน้อยกี่คน และการประชุมต้องมีองค์ประชุมอย่างไร?',
   '"ผู้มีผลประโยชน์ร่วมกัน" หมายถึงอะไร และมีลักษณะความสัมพันธ์กันอย่างไร?'
]
