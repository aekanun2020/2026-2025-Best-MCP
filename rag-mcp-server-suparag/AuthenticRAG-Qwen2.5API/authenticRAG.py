...
# pip install opensearchpy llama-index llama-index-embeddings-huggingface openai requests
...
class AnthropicStyleContextualRAG:
    def __init__(self, opensearch_host="localhost", opensearch_port=9200, ollama_url="http://localhost:11434"):
        ...
        # ตั้งค่า Ollama URL และ embedding model
        self.ollama_url = ollama_url
        self.embedding_model = "bge-m3"
        self.embedding_dim = 1024  # BGE-M3 dimension
        
        print(f"Using Ollama embedding model: {self.embedding_model} at {self.ollama_url}")
        
        # สร้าง wrapper สำหรับ embedding ที่ใช้ Ollama
        ...
        self.encoder = OllamaEmbeddingsWrapper(self.ollama_url, self.embedding_model)
