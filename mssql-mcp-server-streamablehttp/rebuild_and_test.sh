#!/bin/bash
# Complete rebuild and test script for MSSQL MCP Streamable HTTP Server
...
# Remove old images
docker rmi mssql-mcp-streamable-http:latest 2>/dev/null || true
docker rmi streamablehttp-mssqlmcp-mcp-server:latest 2>/dev/null || true
